...
import { createTourDetailTemplate, createTourDetailSkeletonTemplate, createReviewSkeletonTemplate } from "../templates/template-creator";
    ...
    return `
      ...
      <section class="container my-5" id="tour-reviews">
        ...
        <div id="reviews-container" class="row">
          <!-- Skeleton loader untuk reviews -->
          ${createReviewSkeletonTemplate(3)}
        </div>
      </section><br>
