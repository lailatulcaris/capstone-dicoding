    ...
    return `
      <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <picture>
              <source type="image/webp" srcset="./hero-3.webp" class="d-block w-100 img-fluid lazyload">
              <source type="image/jpeg" srcset="./hero-3.jpg" class="d-block w-100 img-fluid lazyload">
              <img data-src="./hero-3.jpg" class="d-block w-100 img-fluid lazyload carousel-image" alt="Image 1">
            </picture>
          ...
          <div class="carousel-item">
            <picture>
              <source type="image/webp" srcset="./hero-2.webp" class="d-block w-100 img-fluid lazyload">
              <source type="image/jpeg" srcset="./hero-2.jpg" class="d-block w-100 img-fluid lazyload">
              <img data-src="./hero-2.jpg" class="d-block w-100 img-fluid lazyload carousel-image" alt="Image 2">
            </picture>
            <div class="carousel-caption">
              <p>CULTURAL DIVERSITY AND BEAUTIFUL TOURISM IN INDONESIA</p>
            </div>
          </div>
          <div class="carousel-item">
            <picture>
              <source type="image/webp" srcset="./hero-1.webp" class="d-block w-100 img-fluid lazyload">
              <source type="image/jpeg" srcset="./hero-1.jpg" class="d-block w-100 img-fluid lazyload">
              <img data-src="./hero-1.jpg" class="d-block w-100 img-fluid lazyload carousel-image" alt="Image 3">
            </picture>
            <div class="carousel-caption">
      ...
      <div class="container mt-5">
        ...
        <div class="row mt-4" id="culture-cards">
          ${createCultureSkeletonTemplate(4)} <!-- Skeleton loader -->
        </div>
      ...
      <div class="container mt-5">
        ...
        <div class="row mt-4" id="tourism-cards">
          ${createTourSkeletonTemplate(4)} <!-- Skeleton loader -->
        </div>
        <div class="text-center mt-3">
